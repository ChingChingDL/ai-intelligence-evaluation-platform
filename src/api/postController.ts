...
export async function deletePostUsingPost(body: API.DeleteRequest, options?: { [key: string]: any }) {
...
export async function editPostUsingPost(body: API.PostEditRequest, options?: { [key: string]: any }) {
...
export async function listPostByPageUsingPost(body: API.PostQueryRequest, options?: { [key: string]: any }) {
...
export async function listPostVoByPageUsingPost(body: API.PostQueryRequest, options?: { [key: string]: any }) {
...
export async function listMyPostVoByPageUsingPost(body: API.PostQueryRequest, options?: { [key: string]: any }) {
...
export async function searchPostVoByPageUsingPost(body: API.PostQueryRequest, options?: { [key: string]: any }) {
...
export async function updatePostUsingPost(body: API.PostUpdateRequest, options?: { [key: string]: any }) {
