...
export async function deleteAppUsingPost(body: API.DeleteRequest, options?: { [key: string]: any }) {
...
export async function listAppByPageUsingPost(body: API.AppQueryRequest, options?: { [key: string]: any }) {
...
export async function listAppVoByPageUsingPost(body: API.AppQueryRequest, options?: { [key: string]: any }) {
...
export async function listMyAppVoByPageUsingPost(body: API.AppQueryRequest, options?: { [key: string]: any }) {
...
/** review POST /api/app/review */
export async function reviewUsingPost(body: API.ReviewRequest, options?: { [key: string]: any }) {
...
export async function updateAppUsingPost(body: API.AppUpdateRequest, options?: { [key: string]: any }) {
